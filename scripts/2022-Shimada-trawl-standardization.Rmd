...
# Save locally:
write_csv(event_trawl, here("standardized_data", "IYS2022_Shimada_event.csv"))
```
...
# Omit certain AphiaIDs that do not apply:
occurrence_specimen_id <- occurrence_specimen_id %>% filter(!AphiaID %in% c("1077913","1434944", "106331"))
...
``` {r}
Shimada2022_eMOF <- dplyr::bind_rows(Shimada2022_trawl_allCatch_eMOF, Shimada2022_ind_eMOF)
